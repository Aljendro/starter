  ...
  opts = function()
    ...
    return {
      ...
      prompts = {
        ...
        ConventionalCommit = {
          prompt = "Write a conventional commit message for the staged changes. If a ticket ID (like AOPS-123456) is found in the branch name, include it in the commit message. Format as: type: TICKET-ID: message. Keep the title under 50 characters and wrap body text at 72 characters. Format as a gitcommit code block.",
